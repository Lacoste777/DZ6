...
public class App {
    ...
    public static void main(String[] arg) {
        laptop laptop1 = new laptop(1, 4, 128, "Win", "red");
        laptop laptop2 = new laptop(2, 8, 256, "Mac", "white");
        laptop laptop3 = new laptop(3, 16, 512, "Android", "black");
        laptop laptop4 = new laptop(4, 32, 1024, "Win", "green");
